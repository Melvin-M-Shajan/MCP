    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 w-6 h-6 rounded-md flex items-center justify-center text-white/0 group-hover:text-white/40 hover:!text-red-400 hover:bg-red-400/10 transition-all duration-200"
                title="Delete chat"
            >
