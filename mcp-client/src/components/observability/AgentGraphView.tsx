...
export function AgentGraphView() {
    ...
    if (agents.length === 0) {
        return (
            <div className="flex items-center justify-center h-full text-white/40 bg-black/20 rounded-xl border border-white/5">
    ...
    return (
        <div className="w-full h-full bg-black/20 rounded-xl border border-white/5 backdrop-blur-md overflow-hidden relative">
            <ReactFlow
                nodes={nodes}
                edges={edges}
                nodeTypes={nodeTypes}
