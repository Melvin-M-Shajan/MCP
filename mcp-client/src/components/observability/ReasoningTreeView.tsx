...
export function ReasoningTreeView() {
    ...
    return (
        <ScrollArea className="h-full rounded-xl bg-black/20 border border-white/5 backdrop-blur-md p-4">
                ...
                <AnimatePresence>
                    {agents.map((agent) => (
                        ...
                        >
                            <AccordionItem
                                value={agent.id}
                                className="border border-white/10 rounded-xl bg-white/5 backdrop-blur-xl px-4 overflow-hidden"
                            >
