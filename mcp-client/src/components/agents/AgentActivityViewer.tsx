...
const statusConfig: Record<AgentStatus, { color: string, icon: any, label: string }> = {
...
export function AgentActivityViewer() {
    ...
    if (agents.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center h-full text-white/30 p-8 text-center bg-black/20 backdrop-blur-md rounded-2xl border border-white/5">
    ...
    return (
        <ScrollArea className="h-full rounded-2xl bg-black/20 backdrop-blur-md border border-white/5 p-4">
                ...
                <AnimatePresence>
                    {agents.map((agent) => {
                        ...
                        return (
                            ...
                            >
                                <Card className="bg-white/5 border-white/10 overflow-hidden shadow-xl backdrop-blur-xl">
                                    {/* Top Header */}
