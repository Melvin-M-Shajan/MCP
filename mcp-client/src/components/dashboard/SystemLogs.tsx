...
export function SystemLogs() {
    ...
    if (logs.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center p-6 text-white/30 text-center h-[200px] bg-black/20 rounded-xl border border-white/5 backdrop-blur-md">
